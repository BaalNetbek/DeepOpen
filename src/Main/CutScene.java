   ...
   public final void resetCamera() {
      ...
      case 4:
         if (this.gameCam_ == null) {
            this.gameCam_ = Camera.create(GlobalStatus.screenWidth, GlobalStatus.screenHeight, 1024, 200, 100000);
   ...
   public final void OnInitialize() {
      try {
         ...
         case 4:
            ...
            break;
         case 23:
            this.hangarCam = Camera.create(GlobalStatus.screenWidth, GlobalStatus.screenHeight, 900, 100, 100000);
