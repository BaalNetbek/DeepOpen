...
public final class HangarWindow {
   ...
   public final void initialize() {
      ...
      Item[] var1 = Item.combineItems(Status.getShip().getCargo(), Status.getStation().getShopItems());
         ...
         if (var1 == 16384) {
            if (this.state__ == 4) {
               ...
               if (this.selectedItem.isItem() || this.selectedItem.isShip() || this.selectedItem.isBluePrint() || this.selectedItem.isPendingProduct()) {
                  this.itemInfo.setup((ListItem)((ListItem)this.list.getSelectedItem()), this.list.items, this.list.itemTypes, this.list.ships, this.list.shipsColor, true);
                  this.state__ = 1;
               }
