...
public final class Renderer {
   ...
   public final void setLight(Matrix lighLocalMatrix,  Light light) {
       AEGraphics3D.setLight(this.camera, lighLocalMatrix, light);
   }
   
   public final void setLights(Matrix lighLocalMatrix,  Light light[]) {
       AEGraphics3D.setLights(this.camera, lighLocalMatrix, light);
   }
   ...
   public final void appendNode(GraphNode var1) {
       try {
          if (var1 != null && this.layers != null && this.camera != null) {
             ...
             var1.forceAppendToRender(this.camera, this);
          }
