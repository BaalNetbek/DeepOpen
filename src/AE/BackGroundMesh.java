...
public final class BackGroundMesh extends AbstractMesh {
   ...
   private javax.microedition.m3g.Node mesh;
   private static CompositingMode compositing;

   public BackGroundMesh(String var1) {
      String var2 = var1;
      ...
      try {
         ...
         for(int var6 = 0; var6 < var3.length; ++var6) {
            if (var3[var6] instanceof javax.microedition.m3g.Group) {
               var5.mesh = (javax.microedition.m3g.Node)var3[var6];
               break;
            }
         }
      ...
      this.radius = 0;
      if (compositing == null) {
         (compositing = new CompositingMode()).setBlending(65);
   ...
   private void setTexture(javax.microedition.m3g.Group var1, Texture2D[] var2) {
