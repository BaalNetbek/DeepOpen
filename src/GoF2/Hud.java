   ...
   public final void draw(long var1, long var3, PlayerEgo var5, boolean var6) {
      if (this.drawUI) {
         ...
         if (this.drawBoostIcon) {
            ...
            GlobalStatus.graphics.setClip(2, var7 + 2 - (int)(var5.getBoostRate() * (float)var7), var7, var7);
            this.hudIcons.setFrame(4);
            this.hudIcons.setPosition(2, 2);
            this.hudIcons.paint(GlobalStatus.graphics);
            GlobalStatus.graphics.setClip(0, 0, GlobalStatus.screenWidth, GlobalStatus.screenHeight);
         ...
         if (var5.isCloakPresent()) {
            ...
            this.hudIcons.paint(GlobalStatus.graphics);
            if (var5.isCloaked()) {
               GlobalStatus.graphics.setClip(GlobalStatus.screenWidth - 2 - this.hudIconsHeight, var7 + 2 - (int)((1.0F - var5.getCloakRate()) * (float)var7), var7, var7);
            } else {
               GlobalStatus.graphics.setClip(GlobalStatus.screenWidth - 2 - this.hudIconsHeight, var7 + 2 - (int)(var5.getCloakRate() * (float)var7), var7, var7);
            }
