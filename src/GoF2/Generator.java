...
public final class Generator {
         ...
         while(true) {
            do {
               if (var7) {
                  ...
                  Agent var12;
                  (var12 = new Agent(-1, Globals.getRandomName(var5, var7), var1.getId(), Status.getSystem().getId(), var5, var7, -1, -1, -1)).setOffer(var8);
                  ...
                  if (var12.getType() == 6) {
                     ...
                     while(true) {
                        ...
                        if (var17 != 164 && var17 != 131 && var16[var17].getBluePrintComponentsIds() == null && var16[var17].getSinglePrice() != 0) {
                           ...
                           var12.setSellItemData(var17, var5, var8);
                           break;
                        }
                     }
                  }
   ...
   public final Mission createFreelanceMission(Agent var1) {
      ...
      Mission var12 = new Mission(var5, var6, var1.getImageParts(), var14, (int)var18, var3, var15);
