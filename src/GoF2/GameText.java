...
public final class GameText {
   public static final short[] LISTITEMWINDOW_KEY_TEXT_IDS = new short[]{157, 157, 157, 37, 36, 36, 36, 36, 36, 50, 42, 53, 54, 57, 43, 59, 52, 53, 60, 44, 58, 56, 45, 58, 53, 55, 58, 45, 46, 47, 59, 48, 49, 58, 53, 69};
   ...
   public static final short[] CAMPAIGN_MISSION_DESC = new short[]{389, 389, 389, 389, 389, 389, 389, 389, 389, 389, 389, 389, 389, 373, 374, 389, 375, 389, 376, 389, 377, 377, 389, 378, 379, 389, 389, 389, 380, 389, 389, 389, 381, 382, 383, 384, 385, 389, 386, 389, 387, 389, 389, 388, 389};
   public static final short[] MISSION_START_MSG = new short[]{201, 202, 203, 204, 205};
   public static final short[] MISSION_SUCCESS_MSG = new short[]{195, 196, 197, 198, 199};
   public static final short[] MISSION_LOST_MSG = new short[]{206, 207, 208, 209, 210};
   ...
   private void readLangFile(String[] var1, String var2) {
   ...
   public final String getText(int var1) {
      if (var1 < 1198) {
         ...
         if (medals[tempId] == null) {
            this.readLangFile(medals, "medals");
         }
         ...
         if (categories_[categoryId_][tempId2] == null) {
            this.readLangFile(categories_[categoryId_], "" + categoryId_);
         }
