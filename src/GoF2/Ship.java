...
public final class Ship {
   public static final short[] SHIP_PREVIEW_SCALING = new short[]{622, 1338, 1066, 783, 1181, 912, 939, 1471, 1199, 1192, 763, 1633, 1103, 2000, 2000, 2000, 1802, 1930, 1590, 1205, 1024, 1623, 1266, 1038, 1370, 1370, 1110, 1276, 1722, 1553, 975, 1175, 627, 1185, 916, 767, 1738};
   public static final short[] SHIP_HANGAR_OFFSETS = new short[]{24, -51, -37, 78, -197, 8, -14, 37, -104, 121, -100, -381, -132, 0, 0, 0, -520, -137, -206, 0, -182, -347, 2, -61, -116, -254, -316, -40, -182, -372, -68, -160, -142, 131, -102, -72, -402};
   private int id;
   private int baseHP;
   ...
   public final boolean removeCargo(int var1, int var2) {
      if (this.cargoHold == null) {
         ...
         if (var3) {
            this.setCargo(Item.extractItems(this.cargoHold, true));
         } else {
            this.setCargo(this.cargoHold);
         }
   ...
   public final void addCargo(Item var1) {
      ...
      this.setCargo(Item.mixItems(this.cargoHold, var2));
   }
   ...
   public final void setSellingPrice() {
      this.price = (int)((float)Globals.getShips()[this.id].getPrice() / 1.25F);
   }

   public final void adjustPrice() {
      if (Status.getStation() != null) {
         this.price = Globals.getShips()[this.id].getPrice() - (int)((float)Status.getStation().getTecLevel() / 100.0F * (float)Globals.getShips()[this.id].getPrice());
      }
