   ...
   public final void drawCurrentLock(Hud var1) {
      if (this.draw) {
         if (this.targetedPlanet != null) {
            ...
            KIPlayer var2;
            if ((var2 = this.targetedAsteroid != null ? this.targetedAsteroid : (this.targetedPlayer != null ? this.targetedPlayer : (this.targetedLandmark != null ? this.targetedLandmark : null))) != null) {
               boolean var3 = var2.equals(this.targetedAsteroid);
               boolean var4 = var2.equals(this.targetedLandmark);
