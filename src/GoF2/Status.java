...
public final class Status {
   ...
   public static void departStation(Station var0) {
      if (var0 != voidStation) {
         Station var1;
         label240: {
      ...
      for(int var15 = 0; var15 < currentMissions.length; ++var15) {
         if (currentMissions[var15] != null) {
            ...
            if (currentMissions[var15].getTargetStation() == var0.getId() && currentMissions[var15].getType() != 8 && currentMissions[var15].getType() != 19 && currentMissions[var15].getType() != 16 && currentMissions[var15].getType() != 14 && currentMissions[var15].getType() != 13) {
   ...
   public static void startNewGame() {
      ...
      Mission var6 = Mission.emptyMission_;
      ...
      playersShip.setCargo((Item[])null);
      Item var7 = Globals.getItems()[3].makeItem();
      playersShip.setEquipment(var7, 0);
      Item var5 = Globals.getItems()[3].makeItem();
