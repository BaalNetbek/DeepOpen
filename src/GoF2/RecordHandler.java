...
public final class RecordHandler {
   ...
   public final GameRecord recordStoreRead(int var1) {
      this.agent = null;
      this.mission = null;
   ...
   private void writeAgent(DataOutputStream var1, Agent var2) throws IOException {
      ...
      if (var2.getMission() != null && this.mission != var2.getMission()) {
         var1.writeInt(1);
         this.writeMission(var1, var2.getMission());
      } else {
         var1.writeInt(-1);
      }
   }
   ...
   private Agent readAgent(DataInputStream var1) throws IOException {
      ...
      var29.setEvent(var5);
      var29.setOffer(var7);
      var29.setSellItemData(var9, var11, var10);
      var29.wingman1Name = var25;
      var29.wingman2Name = var26;
      var29.wingmanFriendsCount = var14;
      var29.giveRewardAtNextChat(var16);
      var29.setOfferAccepted(var17);
      var29.setImageParts(var21);
      var29.setMessage(var28);
      var29.setStationName(var23);
      var29.setSystemName(var24);
