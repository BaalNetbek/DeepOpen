...
public final class Agent {
   ...
   public final void setOffer(int var1) {
      this.type = var1;
   }
   ...
   public final void setSellItemData(int var1, int var2, int var3) {
      this.itemId = var1;
   ...
   public final void setOfferAccepted(boolean var1) {
      this.accepted = var1;
   }
   ...
   public final void giveRewardAtNextChat(boolean var1) {
      this.unused_0_ = var1;
   }
   ...
   public final void setStationName(String var1) {
      this.stationName = var1.equals("") ? null : var1;
   }

   public final void setSystemName(String var1) {
