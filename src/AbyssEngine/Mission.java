...
public final class Mission {
   public static final Mission var_dc = new Mission();
   ...
   public final void sub_91(boolean var1) {
      this.visible_ = var1;
   }

   public final boolean sub_12c() {
   ...
   public final int sub_50f() {
      return this.bonus_;
   }

   public final void sub_54a(int var1) {
      this.bonus_ = var1;
   }
   ...
   public final void setStartedStoryMission(boolean var1) {
      this.startedStoryMission = true;
   }
