...
public final class FileRead {
   ...
   private static Station[] loadStationsBinary(short[] var0) {
      ...
      try {
         InputStream var2 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/stations.bin");
   ...
   public static int[] loadShipParts(int var0) {
      ...
      try {
         InputStream var2 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/shipparts_jsr.bin");
   ...
   public static int[] loadStationParts(int var0, int var1) {
      ...
      try {
         InputStream var8 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/stationparts.bin");
   ...
   public static Agent[] loadAgents() {
      ...
      try {
         InputStream var1 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/agents.bin");
   ...
   public static SolarSystem[] loadSystemsBinary() {
      ...
      try {
         InputStream var1 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/systems.bin");
   ...
   public static Item[] loadItemsBinary() {
      ...
      try {
         InputStream var1 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/items.bin");
   ...
   public static Ship[] loadShipsBinary() {
      ...
      try {
         InputStream var1 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream("/data/txt/ships.bin");
   ...
   public static String[] loadNamesBinary(int var0, boolean var1, boolean var2) {
      ...
      case 3:
         if (var2) {
            var4 = GameStatus.random.nextInt(2) == 0 ? "names_terran_0_m.bin" : "names_nivelian_0.bin";
         } else {
            var4 = GameStatus.random.nextInt(2) == 0 ? "names_terran_1.bin" : "names_nivelian_1.bin";
         }
         break;
      case 4:
      ...
      try {
         var4 = "/data/txt/" + var4;
         InputStream var6 = (varClass == null ? (varClass = sub_229("java.lang.Class")) : varClass).getResourceAsStream(var4);
   ...
   private static Class sub_229(String var0) {
      try {
