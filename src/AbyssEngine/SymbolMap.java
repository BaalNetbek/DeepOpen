...
public final class SymbolMap {
   ...
   public SymbolMap(String var1, Graphics var2, int var3, int var4, int var5) {
      graphics = var2;
      ...
      try {
         ...
         this.tileHeight = this.heightMaxRange = (byte)(this.charTexture.getHeight() / var4);
         this.tileWidth = (byte)(this.charTexture.getWidth() / var5);
         int[] var7 = new int[this.charTexture.getWidth() * this.charTexture.getHeight()];
         ...
         for(int var8 = 0; var8 < var5; ++var8) {
            for(var3 = 0; var3 < var4; ++var3) {
               ...
               this.posY[var8 + var5 * var3] = (short)(var3 * this.heightMaxRange);
               this.widths[var8 + var5 * var3] = this.getSymbolWidths(var8 * this.tileWidth, var3 * this.heightMaxRange, var7);
            }
         }
   ...
   public final void setSpacing(int var1) {
      this.spacing = (byte)var1;
   }

   private byte getSymbolWidths(int var1, int var2, int[] var3) {
      byte var4 = (byte)(this.tileWidth - 1);

      for(byte var5 = 0; var5 < this.tileWidth; ++var5) {
         for(byte var6 = 0; var6 < this.heightMaxRange; ++var6) {
      ...
      for(int var4 = 0; var4 < var1.length(); ++var4) {
         ...
         if ((var6 = charToSymbolIdx(var1.charAt(var4))) == -1) {
            ...
            for(int var5 = 0; var5 < 3; ++var5) {
               var2 += this.widths[var6] + this.spacing;
            }
         } else {
            var2 += this.widths[var6] + this.spacing;
         }
      ...
      for(var2 = var2; var2 < var3; ++var2) {
         ...
         if ((var7 = charToSymbolIdx(var1.charAt(var2))) == -1) {
            ...
            for(int var6 = 0; var6 < 3; ++var6) {
               var4 += this.widths[var7] + this.spacing;
            }
         } else {
            var4 += this.widths[var7] + this.spacing;
         }
      ...
      for(int var6 = 0; var6 < var1.length(); ++var6) {
         ...
         if ((var8 = charToSymbolIdx(var1.charAt(var6))) == -1) {
            ...
            for(int var7 = 0; var7 < 3; ++var7) {
               ...
               var4 += this.widths[var8] + this.spacing;
            }
         } else {
            graphics.drawRegion(this.charTexture, this.posX[var8], this.posY[var8], this.widths[var8], this.tileHeight, 0, var2 + var4, var3 + this.offsetY, 0);
            var4 += this.widths[var8] + this.spacing;
   ...
   public final void sub_162(String var1, int var2, int var3) {
      int var4 = 0;
      boolean var5 = false;
   ...
   public final int getHeightMaxRange() {
   ...
   public final void setHeightMaxRange(int var1) {
      this.heightMaxRange = (byte)var1;
   }
}
