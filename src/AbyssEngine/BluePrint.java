...
public final class BluePrint {
   ...
   public BluePrint(int var1) {
      this.productId = var1;
      this.tonsPerProduction = IndexManager.getItems()[var1].getType() == 1 ? 10 : 1;
      this.productionStationId = -1;
      Item var2 = IndexManager.getItems()[var1];
      int[] var3 = IndexManager.getItems()[var1].getBlueprintComponentsQuantities();
      ...
      if ((var5 = this.getIngredientList()) != null) {
         for(int var4 = 0; var4 < var5.length; ++var4) {
            if (var5[var4] == var1.getIndex()) {
               int[] var10000 = this.missingComponentsTons;
               var10000[var4] -= var2;
               this.investedCredits += var1.getPrice() * var2;
               return;
            }
         }
      }
   ...
   public final int[] getIngredientList() {
      return IndexManager.getItems()[this.productId].getBluePrintComponentsIds();
   }

   private int[] getQuantityList() {
      return IndexManager.getItems()[this.productId].getBlueprintComponentsQuantities();
   }
