...
public final class SolarSystem {
   ...
   public int spaceShadeR;
   public int spaceShadeG;
   public int spaceShadeB;
   ...
   public SolarSystem(int var1, String var2, int var3, boolean var4, int var5, int var6, int var7, int var8, int var9, int var10, int[] var11, int[] var12, int[] var13, int[] var14) {
      ...
      this.spaceShadeR = var11[0];
      this.spaceShadeG = var11[1];
      this.spaceShadeB = var11[2];
   ...
   public final int getJumpgateStationVerifiedIndex() {
      return this.verifyStationInSystem(this.jumpgateStationId);
   }

   public final int verifyStationInSystem(int var1) {
