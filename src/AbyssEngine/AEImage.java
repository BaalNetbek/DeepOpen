...
public final class AEImage {
   ...
   public static Image loadImage(String var0, boolean var1) {
      ...
      if (var1) {
         try {
            InputStream var8 = (clazs == null ? (clazs = loadClass("java.lang.Class")) : clazs).getResourceAsStream(var0);
   ...
   public static byte[] loadFileBytes(String var0) {
      byte[] var1 = null;

      try {
         InputStream var4 = (clazs == null ? (clazs = loadClass("java.lang.Class")) : clazs).getResourceAsStream(var0);
         int var2;
