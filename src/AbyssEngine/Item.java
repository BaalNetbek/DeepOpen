...
public final class Item {
   private static final boolean[] var_ce = new boolean[]{true, true, true, true, true, true, true, true, false, false, false, true, true, false, false, false, false, false, false, false, true, false, true, true, true};
   private int id;
   private int type;
   private int subType;
   ...
   public final boolean sub_18e() {
      return var_ce[this.subType];
   }
   ...
   public final void sub_460(int var1) {
      this.amount = var1;
   }
   ...
   public final void sub_54b(int var1) {
      this.blueprintAmount = var1;
   }

   public final int sub_590() {
      return this.blueprintAmount;
   }

   private void sub_5de(int var1) {
      this.blueprintAmount += var1;
   }
   ...
   public final int sub_6b2(boolean var1) {
      boolean var2 = false;
      int var3;
   ...
   public final int sub_714(boolean var1) {
   ...
   public static boolean sub_737(int var0, int var1, Item[] var2) {
      if (var2 == null) {
         return false;
      } else {
   ...
   public static Item[] sub_797(Item[] var0, boolean var1) {
      if (var0 == null) {
         return null;
      } else {
         ...
         for(int var4 = 0; var4 < var3.length; ++var4) {
            if (var1 && var3[var4].amount > 0) {
               var2[var6] = var3[var4].anyAmountCopies(var3[var4].amount);
               ++var6;
            } else if (!var1 && var3[var4].stationAmount > 0) {
               var2[var6] = var3[var4].anyAmountCopies(var3[var4].stationAmount);
               ++var6;
            }
         }
   ...
   public static Item[] sub_7de(Item[] var0, Item[] var1) {
      ...
      if (var2 > 0 && var3 == 0) {
         for(var3 = 0; var3 < var0.length; ++var3) {
            var4[var3] = var0[var3].anyAmountCopies(var0[var3].amount);
         }
         ...
         if (var3 > 0 && var2 == 0) {
            for(var3 = 0; var3 < var1.length; ++var3) {
               var4[var3] = var1[var3].anyAmountCopies(0);
               var10000 = var4[var3];
            ...
            for(int var6 = 0; var6 < var1.length; ++var6) {
               for(var2 = 0; var2 < var4.length; ++var2) {
                  if (var4[var2] == null) {
                     var4[var2] = var1[var6].anyAmountCopies(0);
                     var10000 = var4[var2];
                  ...
                  if (var1[var6].equals(var4[var2])) {
                     var4[var2] = var1[var6].anyAmountCopies(var4[var2].amount);
                     var10000 = var4[var2];
                     var2 = var1[var6].amount;
                     var10000.stationAmount = var2;
                     break;
   ...
   public static Item[] merge(Item[] var0, Item[] var1) {
      if (var0 == null) {
         return var1;
      } else if (var1 == null) {
         return var0;
   ...
   public final boolean sub_848() {
      return this.type == 0 || this.type == 1 || this.type == 2;
   }

   public final Item anyAmountCopies(int var1) {
   ...
   public final String toString() {
      return IndexManager.getItemName(this.id);
   }

   public final boolean sub_95c() {
      return this.var_730;
   }

   public final void sub_986(boolean var1) {
      this.var_730 = var1;
   }
}
