      ...
      for(var2 = 0; var2 < medalTresholds.length; ++var2) {
         ...
         if (medals[var2] != 1) {
            for(var4 = 0; var4 < medalTresholds[var2].length && var8 <= 0; ++var4) {
               ...
               switch(var2) {
               case 1:
                  var7 = var0.sub_794() <= medalTresholds[var2][var4];
                  break;
               case 2:
               case 3:
               case 9:
               case 12:
                  boolean[] var5 = var2 == 2 ? Status.minedOreTypes : (var2 == 3 ? Status.minedCoreTypes : (var2 == 9 ? Status.drinksVar1 : Status.drinksVar2));
                  var1 = 0;
                  var6 = 0;
               ...
               case 4:
                  ...
                  break;
               case 5:
                  var7 = Status.var_d88 > medalTresholds[var2][var4];
                  break;
               case 6:
               ...
               case 7:
                  ...
                  break;
               case 8:
                  var7 = Status.var_e59 > medalTresholds[var2][var4];
                  break;
               case 10:
                  var7 = Status.var_ea8 > medalTresholds[var2][var4];
                  break;
               case 11:
               ...
               case 17:
                  ...
                  break;
               case 18:
                  var7 = Status.var_f13 > medalTresholds[var2][var4];
                  break;
               case 19:
