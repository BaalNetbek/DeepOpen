...
public final class Standing {
   ...
   public final void sub_d7(int var1) {
      if (var1 == 1) {
         this.stand[0] = 35;
      } else if (var1 == 0) {
         this.stand[0] = -35;
   ...
   public static int oppositeFaction(int var0) {
      switch(var0) {
      case 0:
         return 1;
      case 1:
   ...
   private void standingChange(int var1, int var2) {
      int[] var10000 = this.stand;
      var10000[var1] += var2;
   ...
   public final void sub_24a(int var1) {
      ...
      this.changeStanding(var3, var4);
   }

   public final void incStanding(int var1) {
      this.changeStanding(var1, 2);
   }

   public final void decStanding(int var1) {
      this.changeStanding(var1, -7);
   }

   public final void incStanding2(int var1) {
      this.changeStanding(var1, 2);
   }

   private void changeStanding(int var1, int var2) {
      if (var1 == 1) {
         this.standingChange(0, var2);
      } else if (var1 == 0) {
         this.standingChange(0, -var2);
      } else if (var1 == 3) {
         this.standingChange(1, var2);
      } else {
         if (var1 == 2) {
            this.standingChange(1, -var2);
         }
