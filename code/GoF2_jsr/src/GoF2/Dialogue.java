...
public final class Dialogue {
   ...
   public final boolean OnKeyPress_(int var1) {
      if (!this.popupOpen) {
         boolean var10000;
         if (var1 == 16384) {
      ...
      if (var1 == 256 && (!this.lastPageOn() || !this.firstPageOn())) {
   ...
   public final boolean handleScrollPress_(int var1, int var2) {
      if ((var1 & 64) != 0) {
   ...
   public final void draw() {
      ...
      this.textBox.draw();
      Layout.drawFooter(this.lastPageOn() ? (this.mission.isCampaignMission() && this.type == 2 ? GlobalStatus.gameText.getText(67) : (this.type != 2 && this.type != 1 ? GlobalStatus.gameText.getText(76) : GlobalStatus.gameText.getText(253))) : GlobalStatus.gameText.getText(75), !this.firstPageOn() ? GlobalStatus.gameText.getText(74) : "", !this.lastPageOn() || !this.firstPageOn());
      if (this.popupOpen) {
         this.popup.draw();
      }
