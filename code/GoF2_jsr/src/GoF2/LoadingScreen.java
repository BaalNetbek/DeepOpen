...
public final class LoadingScreen implements Runnable {
	...
	public final void setGameCanvas(final GameCanvas var1) {
		this.canvas = var1;
	}
	...
	public final void startLoading_(final boolean var1) {
		this.startTime = System.currentTimeMillis();
		++Status.loadingsCount;
		this.stateIndicator = GlobalStatus.gameText.getText(var1 ? 214 : 215);
		final int var2 = GlobalStatus.random.nextInt(GameText.tips.length);
