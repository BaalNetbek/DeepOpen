...
public final class LevelScript {
	...
	public LevelScript(final TargetFollowCamera var1, final LookAtCamera var2, final Level var3, final Hud var4, final Radar var5) {
		this.hud = var4;
		this.radar = var5;
		this.level = var3;
		this.step = 0;
	...
	public final boolean process(final int var1, final TargetFollowCamera var2) {
		final RadioMessage[] var3 = this.level.getMessages();
		final PlayerEgo var4 = this.level.getPlayer();
		final Camera var5 = GlobalStatus.renderer.getCamera();
		final KIPlayer[] var6 = this.level.getEnemies();
		int var7;
		if (this.active) {
			...
			if (Status.getCurrentCampaignMission() != 0) {
				...
				if (this.step < 6) {
					for(var7 = 0; var7 < 2; ++var7) {
						final int var8 = AEMath.sin(this.passedTime) >> 10;
				...
				if (var3[10].isTriggered() && this.step == 7) {
			...
			if (this.level.getPlayer() != null && Status.getCurrentCampaignMission() > 1 && this.passedTime > 7000) {
				...
				this.startSequenceIsOver = true;
				this.lookAtCam.setLookAt(false);
				var2.setPostition(GlobalStatus.renderer.getCamera().getPostition());
				var2.setLookAtCam(true);
	...
	public static void resetCamera(final TargetFollowCamera var0, final Level var1) {
	...
	public static void lookBehind(final TargetFollowCamera var0) {
	...
	public final void setAutoPilotToProgrammedStation() {
		if (Level.programmedStation != null) {
			...
			final SolarSystem var10000 = Status.getSystem();
			final Station var2 = Level.programmedStation;
			...
			int var1 = Status.getSystem().getJumpGateEnumIndex();
			if (var1 >= 0) {
