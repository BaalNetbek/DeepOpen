...
public class HangarList extends TabbedWindow_ {
   ...
   public final void initShipTab(Ship var1) {
      String var2 = null;
      if (this.items == null) {
         try {
      ...
      ListItem[] var9 = new ListItem[var1.getEquipment().length + 2 + var1.getSlotAvailableTypes()];
      byte var3 = 0;
      int var8 = var3 + 1;
   ...
   public final void initBlueprintTab(BluePrint[] var1) {
      if (var1 != null) {
         ...
         this.listsLenghts[2] = this.displayedEntriesCount;
         this.updateScroll();
      }
   }
   ...
   public final void initShopTab(Item[] var1) {
      ...
      if (var1 != null) {
         ...
         for(var2 = 0; var2 < var1.length; ++var2) {
            int var10002 = this.stationItemTypeCounts[var1[var2].getType()]++;
         }
         ...
         this.listsLenghts[1] = this.displayedEntriesCount;
         this.updateScroll();
      }
   }
   ...
   private void initMountingWindow(ListItem var1) {
      ...
      int var11 = !var2 && !var1.isMedal__() ? 2 : 0;
      ...
      this.listsLenghts[3] = this.displayedEntriesCount;
      this.updateScroll();
   }
   ...
   private void fillIngredientsList(BluePrint var1) {
      ...
      this.listsLenghts[4] = this.displayedEntriesCount;
      this.updateScroll();
   }
   ...
   public final void scrollUp() {
      if (!this.trading_ && !this.popupOpen) {
         ...
         if (this.selectedEntry == 0 || this.selectedEntry == 1 && !((ListItem)((ListItem)this.perTabEntries[this.selectedTab][0])).isSelectable) {
            var2 = this.listsLenghts[this.selectedTab] - 1;
            this.selectedEntry = this.listsLenghts[this.selectedTab] - 1;
            this.scrollPos = this.listsLenghts[this.selectedTab] - this.displayedEntriesCount - 1;
         }
   ...
   public final void scrollDown() {
      if (!this.trading_ && !this.popupOpen) {
         ...
         for(int var3 = this.selectedEntry; var3 < this.listsLenghts[this.selectedTab] - 1; ++var3) {
            if (((ListItem)((ListItem)this.perTabEntries[this.selectedTab][var3 + 1])).isSelectable) {
               var1 = true;
               break;
            }
         ...
         if (this.selectedEntry == this.listsLenghts[this.selectedTab] - 1 || this.selectedEntry == this.listsLenghts[this.selectedTab] - 3 && !((ListItem)((ListItem)this.perTabEntries[this.selectedTab][this.selectedEntry + 1])).isSelectable && !((ListItem)((ListItem)this.perTabEntries[this.selectedTab][this.selectedEntry + 2])).isSelectable) {
            var2 = 0;
         ...
         if (var2 < this.listsLenghts[this.selectedTab] - 1 && !((ListItem)((ListItem)this.perTabEntries[this.selectedTab][this.selectedEntry])).isSelectable) {
            this.scrollDown();
         }
   ...
   public final int selectItem() {
      ...
      if (this.popupOpen) {
         ...
         if (!this.isIngredientShippingPopup) {
            ...
            if (this.popup.getChoice()) {
               ...
               this.initShipTab(Status.getShip());
               this.initShopTab(Item.combineItems(Status.getShip().getCargo(), Status.getStation().getShopItems()));
         ...
         if (this.popup.getChoice()) {
            if (!this.trading_) {
               ...
               this.trading_ = true;
               int var2 = this.amountToPutInBluePrint;
      ...
      if (this.perTabEntries[this.selectedTab] != null && this.perTabEntries[this.selectedTab][this.selectedEntry] != null) {
         ...
         if (this.selectedTab == 4 && this.trading_ && this.amountToPutInBluePrint > 0 && !this.popupOpen && !this.bluePrint.isStarted() && this.bluePrint.getProductionStationId() != Status.getStation().getId()) {
            String var11 = Status.replaceTokens(Status.replaceTokens(new String(GlobalStatus.gameText.getText(142)), this.bluePrint.getProductionStationName(), "#S"), Layout.formatCredits(var1.item.getBlueprintAmount() * 10), "#C");
               ...
               if (this.selectedTab == 1) {
                  ...
                  if (this.selectedTab == 3) {
                     if (this.selectedEntry > 2) {
                        Item var7;
                        if ((var7 = ((ListItem)this.perTabEntries[this.selectedTab][1]).item) != null && var7.setUnsaleable()) {
                           this.popup.setAsWarning(GlobalStatus.gameText.getText(160));
                           this.popupOpen = true;
                           return 0;
                        }
                        ...
                        if (var1.isNonFancyHeader()) {
                           ...
                           ListItem var12 = (ListItem)this.perTabEntries[this.selectedTab][1];
   ...
   public final void updateScroll() {
      ...
      super.updateScroll();
      if (this.listsLenghts[this.selectedTab] > 0 && this.selectedEntry == 0 && !(this.listsLenghts[this.selectedTab] == 0 ? false : ((ListItem)((ListItem)this.perTabEntries[this.selectedTab][this.selectedEntry])).isSelectable)) {
         ++this.selectedEntry;
         super.updateScroll();
      }
   ...
   public void drawFrame() {
      ...
      boolean var1;
      if ((var1 = this.shipLoad > Status.getShip().getCargoPlus()) && Layout.quickTickHigh_() || !var1) {
      ...
      if (this.selectedTab != 0 && this.selectedTab != 3) {
         if (this.selectedTab != 1 && this.selectedTab != 4) {
            ...
            if (var9.isHeader()) {
               ...
               ImageFactory.drawItem(var9.getIndex(), Globals.getItems()[var9.getIndex()].getType(), this.items, this.itemTypes, this.innerLeftMargin + 1, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               if (var2 == this.selectedEntry) {
                  GlobalStatus.graphics.drawImage(this.itemTypesSel, this.innerLeftMargin + 1, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               }
            ...
            if (!var9.isHeader()) {
               ...
               if (var9.isShip()) {
                  ImageFactory.drawShip(var9.ship.getIndex(), var9.ship.getRace(), this.ships, this.shipsColor, this.innerLeftMargin + 3 + 20, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               ...
               ImageFactory.drawItem(var9.item.getIndex(), var9.item.getType(), this.items, this.itemTypes, this.innerLeftMargin + 3 + 20, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               if (var2 == this.selectedEntry) {
                  GlobalStatus.graphics.drawImage(this.itemTypesSel, this.innerLeftMargin + 3 + 20, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               }
         ...
         if (!var9.isHeader()) {
            if (var9.isShip()) {
               ImageFactory.drawShip(var9.ship.getIndex(), var9.ship.getRace(), this.ships, this.shipsColor, this.innerLeftMargin + 1, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
            ...
            if (var9.isItem()) {
               ImageFactory.drawItem(var9.item.getIndex(), var9.item.getType(), this.items, this.itemTypes, this.innerLeftMargin + 1, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               if (var2 == this.selectedEntry) {
                  GlobalStatus.graphics.drawImage(this.itemTypesSel, this.innerLeftMargin + 1, this.itemListPosY + (var2 - this.scrollPos) * this.rowHeight + this.getRowHeight() / 2 + 1, 6);
               }
