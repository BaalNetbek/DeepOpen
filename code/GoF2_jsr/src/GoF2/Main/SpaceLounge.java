   ...
   public final boolean handleKeystate(int var1) {
      if (this.starMapOpen) {
         ...
         case 0:
            ...
            if (var7) {
               AbstractMesh var11 = this.scene.level.getEnemies()[this.selectedAgent].mainMesh_;
         ...
         case 3:
            ...
            break;
         case 2:
            int var2 = this.agents[this.selectedAgent].getMission() != null && this.agents[this.selectedAgent].getMission().isOutsideMission() ? 5 : (this.agents[this.selectedAgent].getType() != 2 && this.agents[this.selectedAgent].getType() != 3 ? 3 : 4);
            ...
            if (var1 == 16384 || var1 == 256) {
               ...
               case 4:
                  ...
                  var3 = (int)((float)this.agents[this.selectedAgent].getMission().getDifficulty() / 10.0F * 5.0F);
      ...
      if (this.itemDescriptionOpen) {
         ...
         if (this.chatType_ == 0) {
            ...
            if (var5.chatType_ != 1 && var5.chatType_ != 3) {
               ...
               if ((var3 = var5.agents[var5.selectedAgent].getType()) != 2 && var3 != 3) {
   ...
   private void startChat() {
      ...
      if (!(var1 = this.agents[this.selectedAgent]).isGenericAgent_()) {
         ...
         if (var1.isKnown() && var1.getType() != 7) {
            ...
            ++Status.barInteractions;
            int var2;
            boolean var3 = (var2 = var1.getType()) != 1 && var2 != 7;
