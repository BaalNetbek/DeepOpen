...
public final class Popup {
    ...
    public Popup(final int var1, final int var2, final int var3) {
        this.posX = var1;
        this.posY = var2;
        this.width = var3;
    ...
    public final void setAsWarning(final String var1) {
        set(var1, false);
    }

    public final void set(final String var1, final boolean var2) {
