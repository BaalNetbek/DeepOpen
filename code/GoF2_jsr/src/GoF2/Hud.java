...
public final class Hud {
   ...
   private void init() {
      try {
         ...
         Item var6 = Status.getShip().getFirstEquipmentOfSort(21);
         Item var9 = Status.getShip().getFirstEquipmentOfSort(18);
   ...
   public final void draw(long var1, long var3, PlayerEgo var5, boolean var6) {
      if (this.drawUI) {
         ...
         if (this.drawBoostIcon) {
            ...
            GlobalStatus.graphics.setClip(2, var7 + 2 - (int)(var5.getBoostCharge() * (float)var7), var7, var7);
            this.hudIcons.setFrame(4);
            this.hudIcons.setPosition(2, 2);
            this.hudIcons.paint(GlobalStatus.graphics);
            GlobalStatus.graphics.setClip(0, 0, GlobalStatus.screenWidth, GlobalStatus.screenHeight);
         ...
         if (var5.isCloakPresent()) {
            ...
            this.hudIcons.paint(GlobalStatus.graphics);
            if (var5.isCloaked()) {
               GlobalStatus.graphics.setClip(GlobalStatus.screenWidth - 2 - this.hudIconsHeight, var7 + 2 - (int)((1.0F - var5.getCloakRechargeRate()) * (float)var7), var7, var7);
            } else {
               GlobalStatus.graphics.setClip(GlobalStatus.screenWidth - 2 - this.hudIconsHeight, var7 + 2 - (int)(var5.getCloakRechargeRate() * (float)var7), var7, var7);
            }
         ...
         if (var10 < 100 && this.hullDamageTick < 3000) {
            if (Layout.quickTickHigh_()) {
               this.hullDamageTick = (int)((long)this.hullDamageTick + var1);
   ...
   public final void drawBigDigits(int var1, int var2, int var3, boolean var4) {
      if (var1 > 9) {
   ...
   public final void drawMenu_(int var1) {
      int var2 = GlobalStatus.screenHeight >> 1;
      int var3 = GlobalStatus.screenWidth >> 1;
      if (this.actionmenuConverging) {
         ...
         if (this.menuReady) {
            ...
            if (Status.wingmenTimeRemaining > 0) {
               Font.drawString(GlobalStatus.gameText.getText(152) + ": " + Time.timeToHMS((long)Status.wingmenTimeRemaining), var3, GlobalStatus.screenHeight - 30, 0, 24);
            }
         }
