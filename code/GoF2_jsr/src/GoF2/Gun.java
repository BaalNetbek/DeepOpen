         ...
         for(int var11 = 0; var11 < var9.projectilesPos.length; ++var11) {
            if (var9.projectilesTimeLeft[var11] <= 0) {
               ...
               if (var9.spread > 0) {
                  ...
                  var10000.x += -(var9.spread >> 1) + GlobalStatus.random.nextInt(var9.spread);
                  var10000 = var9.projectilesDir[var11];
                  var10000.y += -(var9.spread >> 1) + GlobalStatus.random.nextInt(var9.spread);
                  var10000 = var9.projectilesDir[var11];
                  var10000.z += -(var9.spread >> 1) + GlobalStatus.random.nextInt(var9.spread);
               }
               ...
               if (!var9.friendGun && var9.ammo > 0 && var3 != null && var3.getType() == 1) {
                  ...
                  var3.changeAmount(-1);
                  if (var9.ammo == 0) {
                     Status.getShip().removeSimilarEquipment(var3);
                  }
               }
