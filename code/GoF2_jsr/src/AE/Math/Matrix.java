...
public final class Matrix {
    ...
    public final void setRotation(int x, int y, int z) {
        ...
        case 0: // Tait–Bryan XYZ
            var7 = var1 * var3 >> AEMath.Q;
            var8 = var3 * var4 >> AEMath.Q;
            var9 = var5 * var6 >> AEMath.Q;
            this.rightX = var2 * var3 >> AEMath.Q;
            this.upX = -(var2 * var6 >> AEMath.Q);
            this.dirX = var5;
            this.rightY = (var8 * var5 >> AEMath.Q) + (var1 * var6 >> AEMath.Q);
            this.upY = var7 - (var9 * var4 >> AEMath.Q);
            this.dirY = -(var2 * var4 >> AEMath.Q);
            this.rightZ = -(var7 * var5 >> AEMath.Q) + (var4 * var6 >> AEMath.Q);
            this.upZ = var8 + (var9 * var1 >> AEMath.Q);
            this.dirZ = var1 * var2 >> AEMath.Q;
            return;
        case 1: // Tait–Bryan XZY
            var7 = var2 * var6 >> AEMath.Q;
            var8 = var5 * var6 >> AEMath.Q;
            this.rightX = var2 * var3 >> AEMath.Q;
            this.upX = -var6;
            this.dirX = var3 * var5 >> AEMath.Q;
            this.rightY = (var4 * var5 >> AEMath.Q) + (var7 * var1 >> AEMath.Q);
            this.upY = var1 * var3 >> AEMath.Q;
            this.dirY = -(var2 * var4 >> AEMath.Q) + (var8 * var1 >> AEMath.Q);
            this.rightZ = -(var1 * var5 >> AEMath.Q) + (var7 * var4 >> AEMath.Q);
            this.upZ = var3 * var4 >> AEMath.Q;
            this.dirZ = (var1 * var2 >> AEMath.Q) + (var8 * var4 >> AEMath.Q);
            return;
        case 2: // Tait–Bryan YXZ
            var7 = var2 * var3 >> AEMath.Q;
            var8 = var4 * var6 >> AEMath.Q;
            var9 = var5 * var3 >> AEMath.Q;
            this.rightX = var7 + (var8 * var5 >> AEMath.Q);
            this.upX = (var9 * var4 >> AEMath.Q) - (var2 * var6 >> AEMath.Q);
            this.dirX = var1 * var5 >> AEMath.Q;
            this.rightY = var1 * var6 >> AEMath.Q;
            this.upY = var1 * var3 >> AEMath.Q;
            this.dirY = -var4;
            this.rightZ = -var9 + (var8 * var2 >> AEMath.Q);
            this.upZ = (var7 * var4 >> AEMath.Q) + (var5 * var6 >> AEMath.Q);
            this.dirZ = var1 * var2 >> AEMath.Q;
            return;
        case 3:
            var7 = var4 * var5 >> AEMath.Q;
            var8 = var1 * var2 >> AEMath.Q;
            var9 = var2 * var4 >> AEMath.Q;
            this.rightX = var2 * var3 >> AEMath.Q;
            this.upX = var7 - (var8 * var6 >> AEMath.Q);
            this.dirX = (var1 * var5 >> AEMath.Q) + (var9 * var6 >> AEMath.Q);
            this.rightY = var6;
            this.upY = var1 * var3 >> AEMath.Q;
            this.dirY = -(var3 * var4 >> AEMath.Q);
            this.rightZ = -(var3 * var5 >> AEMath.Q);
            this.upZ = var9 + ((var1 * var5 >> AEMath.Q) * var6 >> AEMath.Q);
            this.dirZ = var8 - (var7 * var6 >> AEMath.Q);
            return;
        case 4:
            var7 = var4 * var5 >> AEMath.Q;
            var8 = var2 * var4 >> AEMath.Q;
            this.rightX = (var2 * var3 >> AEMath.Q) - (var7 * var6 >> AEMath.Q);
            this.upX = -(var1 * var6 >> AEMath.Q);
            this.dirX = (var3 * var5 >> AEMath.Q) + (var8 * var6 >> AEMath.Q);
            this.rightY = (var7 * var3 >> AEMath.Q) + (var2 * var6 >> AEMath.Q);
            this.upY = var1 * var3 >> AEMath.Q;
            this.dirY = -(var8 * var3 >> AEMath.Q) + (var5 * var6 >> AEMath.Q);
            this.rightZ = -(var1 * var5 >> AEMath.Q);
            this.upZ = var4;
            this.dirZ = var1 * var2 >> AEMath.Q;
            return;
        case 5:
            var7 = var5 * var6 >> AEMath.Q;
            var9 = var3 * var5 >> AEMath.Q;
            this.rightX = var2 * var3 >> AEMath.Q;
            this.upX = (var9 * var4 >> AEMath.Q) - (var1 * var6 >> AEMath.Q);
            this.dirX = (var9 * var1 >> AEMath.Q) + (var4 * var6 >> AEMath.Q);
            this.rightY = var2 * var6 >> AEMath.Q;
            this.upY = (var1 * var3 >> AEMath.Q) + (var7 * var4 >> AEMath.Q);
            this.dirY = -(var3 * var4 >> AEMath.Q) + (var7 * var1 >> AEMath.Q);
            this.rightZ = -var5;
            this.upZ = var2 * var4 >> AEMath.Q;
            this.dirZ = var1 * var2 >> AEMath.Q;
        default:
        }
    }
